      ...
      <div className="grid place-items-center px-8 lg:px-36 lg:pt-10 ">
        <div className="relative w-full">
          ...
          <img
            ...
            alt="profile"
            className="rounded-full border-4 border-white h-20 w-20 md:h-32 md:w-32  lg:h-[240px] lg:w-[240px] absolute bottom-[-40px] left-[30px] md:bottom-[-60px] md:left-[30px] lg:bottom-[-75px] lg:left-[100px]"
          />
          <div className="flex items-center gap-4 text-base md:text-3xl lg:text-3xl font-bold text-white absolute left-[120px] md:left-[180px] md:bottom-[-43px] lg:left-[350px] lg:bottom-[-40px]">
