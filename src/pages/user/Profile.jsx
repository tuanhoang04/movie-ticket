      ...
      <div className="grid place-items-center p-20">
        <div className="relative w-fit">
            ...
            <Tabs value="profile" className="w-full mt-32 bg-white bg-opacity-10 rounded-3xl ">
                ...
                <Tab value="posts" className="text-white w-56">Your post</Tab>
                <Tab value="ticketBookeds" className="text-white w-56">Ticket booked</Tab>
                <Tab value="likedMovies" className="text-white w-56">Liked movies</Tab>
                </TabsHeader>
