    ...
    <div className="bg-[#1C1B21] min-h-screen flex flex-col">
      ...
      <div className="flex-grow">
        ...
        <div className="px-8 lg:px-36">
          {!isLoading && (
            <div className="flex flex-col mt-7 mb-16">
              <div className="flex items-center justify-center">
                <p className="text-white text-4xl mb-4">Buy Ticket by Movies</p>
              </div>
        ...
        <div className="flex items-center justify-center">
          <p className="text-white text-4xl mb-4">Buy Ticket by Theaters</p>
        </div>
                    ...
                    <div className="rounded-xl p-5 bg-white bg-opacity-10">
                      <div className="flex justify-between items-center w-full">
                        <div className="flex  items-center gap-3 ">
                          <img
                            src={getTheaterLogo(
                              currentCinema.info.cluster_name
                            )}
                            alt="logo"
                            className={theaterImgStyle}
                            style={{
