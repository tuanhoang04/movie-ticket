...
export default function Dropdown({ label, options }) {
  return (
    <Menu className="text-white text-xl w-60 border-none after:border-none before:border-none">
      <MenuHandler>
        <Button variant="outlined" className="text-white border-2 border-white">
          {label}
        </Button>
      </MenuHandler>
      <MenuList className="bg-[#313035] text-white border-0 overflow-auto overflow-x-hidden dark-scrollbar h-[200px]">
