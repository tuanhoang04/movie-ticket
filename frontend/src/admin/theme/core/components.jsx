...
const MuiDrawer = {
    styleOverrides: {
        paper: {
            backgroundColor: '#502A50', // Thay đổi màu nền sidebar
            boxShadow: '0 0 30px rgba(0,0,0,0.25)', // Thêm shadow
        }
    }
};
...
const MuiListItemButton = {
    styleOverrides: {
        root: {
            borderRadius: '8px', // Tạo corner radius cho các item
            margin: '2px 0', // Tạo khoảng cách giữa các item
            '&.Mui-selected': {
